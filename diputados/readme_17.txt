...
### R
path <- 'https://raw.githubusercontent.com/tresquintos/datos/master/diputados/diputados_17.csv'                
df <- read.csv(path, header =  TRUE, sep = ',', stringsAsFactors =FALSE)
length(df)

### Stata 
import delimited "https://raw.githubusercontent.com/tresquintos/datos/master/diputados/diputados_17.csv", encoding(utf8) clear
