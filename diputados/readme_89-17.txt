...
Serie: “Elecciones Diputados, 1989-2017”
Base: "diputados_89-17"
...
### R
path <- 'https://raw.githubusercontent.com/tresquintos/datos/master/diputados/diputados_89-17.csv'                
df <- read.csv(path, header =  TRUE, sep = ',', stringsAsFactors =FALSE)
length(df)

### Stata 
import delimited "https://raw.githubusercontent.com/tresquintos/datos/master/diputados/diputados_89-17.csv", encoding(utf8) clear
