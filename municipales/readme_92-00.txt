...
Serie: “Elecciones Municipales, 1992-2000”
Base: "municipales_92-00"
...
### R
path <- 'https://raw.githubusercontent.com/tresquintos/datos/master/municipales/municipales_92-00.csv'
             
df <- read.csv(path, header =  TRUE, sep = ',', stringsAsFactors =FALSE)
length(df)

### Stata 
import delimited "https://raw.githubusercontent.com/tresquintos/datos/master/municipales/municipales_92-00.csv", encoding(utf8) clear
