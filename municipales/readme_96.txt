...
### R
path <- 'https://raw.githubusercontent.com/tresquintos/datos/master/municipales/municipales_96.csv'
             
df <- read.csv(path, header =  TRUE, sep = ',', stringsAsFactors =FALSE)
length(df)

### Stata 
import delimited "https://raw.githubusercontent.com/tresquintos/datos/master/municipales/municipales_96.csv", encoding(utf8) clear
